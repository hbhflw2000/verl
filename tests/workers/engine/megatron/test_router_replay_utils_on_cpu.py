...
def test_router_replay_index_trace_layer_supports_jagged_nested_tensor():
    ...
    actual = rr_utils._router_replay_index_trace_layer(nested, 1)

    expected = torch.tensor([[3, 4], [7, 8], [11, 12]])
